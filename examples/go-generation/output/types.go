...
type PaymentMethodDebitCard struct {
	Value DebitCard `json:"value"`
}

func (PaymentMethodDebitCard) isPaymentMethod() {}
...
type PaymentMethodBankTransfer struct {
	Value BankTransfer `json:"value"`
}

func (PaymentMethodBankTransfer) isPaymentMethod() {}
