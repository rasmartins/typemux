...
func GetBuiltinAnnotations() *AnnotationRegistry {
	...
	// Deprecated annotations (for backward compatibility)
	registry.Register(&AnnotationMetadata{
		Name:              "@http",
		Scope:             []string{"method"},
		Formats:           []string{"openapi"},
		Description:       "Specifies HTTP method (deprecated, use @http.method instead)",
		Deprecated:        true,
		DeprecatedMessage: "Use @http.method() instead. This annotation is maintained for backward compatibility.",
		Parameters: []ParameterMetadata{
			{
				Name:        "method",
				Type:        "string",
	...
	registry.Register(&AnnotationMetadata{
		...
		Scope:             []string{"method"},
		Formats:           []string{"openapi"},
		Description:       "Specifies success codes (deprecated, use @http.success instead)",
		Deprecated:        true,
		DeprecatedMessage: "Use @http.success() instead. This annotation is maintained for backward compatibility.",
		Parameters: []ParameterMetadata{
			{
				Name:        "codes",
				Type:        "list",
		...
		Examples: []string{`@success(201,204)`},
	})
	...
	registry.Register(&AnnotationMetadata{
		...
		Scope:             []string{"method"},
		Formats:           []string{"openapi"},
		Description:       "Specifies error codes (deprecated, use @http.errors instead)",
		Deprecated:        true,
		DeprecatedMessage: "Use @http.errors() instead. This annotation is maintained for backward compatibility.",
		Parameters: []ParameterMetadata{
			{
				Name:        "codes",
				Type:        "list",
		...
		Examples: []string{`@errors(400,404,500)`},
	})
